          ...
          >
            ...
            <form onSubmit={handleSubmit} className="p-5 space-y-4">
              <div className="p-3 bg-red-50 text-red-700 border border-red-100 rounded-xl text-[11px] leading-relaxed flex gap-2">
                <Sparkles size={16} className="shrink-0 text-red-600 mt-0.5 animate-pulse" />
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2.5 text-xs border border-gray-200 rounded-xl focus:outline-hidden focus:ring-2 focus:ring-red-500 bg-gray-50/30 font-medium text-gray-800"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2.5 text-xs border border-gray-200 rounded-xl focus:outline-hidden focus:ring-2 focus:ring-red-500 bg-white cursor-pointer font-medium text-gray-800"
                  >
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 text-xs border border-gray-200 rounded-xl focus:outline-hidden focus:ring-2 focus:ring-red-500 bg-gray-50/30 font-mono font-bold text-gray-800"
                  />
                </div>
              </div>
