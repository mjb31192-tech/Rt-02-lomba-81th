        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
          ...
          >
            ...
            <div className="w-full md:w-1/2 p-5 border-b md:border-b-0 md:border-r border-gray-100 flex flex-col md:h-full min-h-0 bg-gray-50/50">
              ...
              {isAddingNew ? (
                <form onSubmit={handleCreateKK} className="bg-white p-4 rounded-xl border border-red-100 space-y-3 shadow-3xs mb-3 shrink-0">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 text-xs border border-gray-200 rounded-lg focus:outline-hidden focus:ring-2 focus:ring-red-500 font-medium text-gray-800"
                    />
                  </div>
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-3 py-2 text-xs border border-gray-200 rounded-lg bg-white font-medium cursor-pointer"
                    >
                  ...
                  <button
                    type="submit"
                    className="w-full py-2 bg-red-600 hover:bg-red-700 text-white font-bold text-xs rounded-lg transition-all cursor-pointer"
                  >
                    Simpan KK
                  </button>
                </form>
                ...
                <div className="space-y-2 mb-3 shrink-0">
                  <input
                    ...
                    className="w-full px-3 py-2 text-xs bg-white border border-gray-200 rounded-xl focus:outline-hidden focus:ring-2 focus:ring-red-500 font-medium text-gray-800"
                  />
            ...
            <div className="w-full md:w-1/2 p-5 flex flex-col justify-between md:h-full min-h-0 bg-white">
              <div className="flex items-center justify-between pb-3 border-b border-gray-100 mb-3.5 shrink-0">
                ...
                <button 
                  type="button"
                  onClick={onClose} 
                  className="hover:bg-gray-100 p-1.5 rounded-lg text-gray-400 hover:text-gray-600 transition-all cursor-pointer"
                >
                  <X size={18} />
                </button>
              </div>
              ...
              {selectedKK ? (
                <div className="flex-1 flex flex-col justify-between min-h-0 space-y-4">
                  {/* KK Summary Details */}
                  <div className="bg-gray-50/50 border border-gray-100 p-3.5 rounded-2xl space-y-2 shrink-0">
                    ...
                    <div className="flex-1 overflow-y-auto bg-gray-50/20 border border-gray-100 rounded-xl p-2 space-y-1.5 max-h-[110px]">
                      {selectedKK.riwayat.length === 0 ? (
                        ...
                        selectedKK.riwayat.map((hist, idx) => (
                          <div key={idx} className="flex items-center justify-between bg-white px-2.5 py-1.5 rounded-lg border border-gray-100 text-xs font-medium text-gray-800">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3 shrink-0">
                      ...
                      <>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2.5 text-xs border border-gray-200 rounded-xl focus:outline-hidden focus:ring-2 focus:ring-red-500 font-mono font-bold text-gray-800"
                          />
                        </div>
                        {/* Presets */}
                    ...
                    <div className="pt-2 flex items-center justify-end gap-2 border-t border-gray-50">
                      <button
                        ...
                        className="w-full py-2.5 bg-red-600 hover:bg-red-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-bold text-xs rounded-xl shadow-xs transition-all active:scale-95 cursor-pointer hover:shadow-md hover:shadow-red-100"
                      >
