        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
          ...
          >
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="font-display font-black text-gray-800 text-sm uppercase tracking-wider">
                    {lombaToEdit ? 'Ubah Informasi Lomba' : 'Tambah Lomba Baru'}
                  </h3>
            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-5 space-y-4">
              ...
              {pendingRequests.length > 0 && !lombaToEdit && (
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-hidden focus:ring-2 focus:ring-red-500 focus:border-red-500 bg-gray-50/30 transition-all font-mono font-medium text-gray-800"
                    />
                  </div>
                </div>
