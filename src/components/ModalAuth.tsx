  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4 z-50 animate-fade-in">
      <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl border border-gray-100 overflow-hidden animate-scale-up relative">
        ...
        {/* Core Body Container */}
        <div className="p-6">
          {/* SENSITIVE GATE OVERLAY (SENSITIVE SECURITY SENSOR) */}
          {showPanitiaGate ? (
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-gray-50 border border-gray-200 rounded-xl pl-9 pr-3 py-2 text-xs text-gray-800 focus:outline-hidden focus:ring-1 focus:ring-red-500"
                    />
                  </div>
                </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full bg-gray-50 border border-gray-200 rounded-xl pl-10 pr-4 py-2.5 text-xs text-gray-800 placeholder-gray-400 focus:outline-hidden focus:ring-1 focus:ring-red-500"
                        />
                      </div>
                    </div>
                  )}
                ...
                <form onSubmit={handleVerifyOTP} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-center text-sm font-bold tracking-widest text-red-600 placeholder-gray-300 focus:outline-hidden focus:ring-1 focus:ring-red-500 font-mono"
                    />
            ...
            <div className="space-y-4 animate-fade-in">
              ...
              {wargaTab === 'login' ? (
                <form onSubmit={handleLoginSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-gray-50 border border-gray-200 rounded-xl pl-10 pr-4 py-2.5 text-xs text-gray-800 placeholder-gray-400 focus:outline-hidden focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500"
                      />
                    </div>
                  </div>
                  ...
                  {/* SENSITIVE CHIP CARDS (Quick Access is hidden behind a click to reveal) */}
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {accounts.map((acc) => (
                        <button
                          ...
                          className="text-left bg-gray-50 hover:bg-indigo-50 border border-gray-100 hover:border-indigo-200 p-2 rounded-xl transition-all group cursor-pointer"
                        >
                          <p className="text-[10px] font-bold text-gray-700 group-hover:text-indigo-800 leading-none truncate">
                            {acc.nama}
                          </p>
                          <p className="text-[8px] text-gray-400 group-hover:text-indigo-500/80 font-semibold mt-0.5 uppercase tracking-wide">
                            {acc.jabatan}
                          </p>
                        </button>
                      ))}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        className="w-full bg-gray-50 border border-gray-200 rounded-xl pl-10 pr-4 py-2.5 text-xs text-gray-800 focus:outline-hidden focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 cursor-pointer appearance-none"
                      >
        ...
        {/* BOTTOM SENSITIVE MASKED AREA (Only shown when not already unlocked as panitia, and when gate is not already open) */}
