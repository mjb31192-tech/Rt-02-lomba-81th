            ...
            <form onSubmit={handleSubmit} className="p-5 space-y-4">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-hidden focus:ring-2 focus:ring-amber-500 focus:border-amber-500 bg-white cursor-pointer transition-all font-medium text-gray-800"
                >
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 text-sm border border-gray-200 rounded-xl focus:outline-hidden focus:ring-2 focus:ring-amber-500 focus:border-amber-500 bg-gray-50/30 transition-all font-medium text-gray-800"
                  />
                </div>
              ...
              <div className="pt-3 border-t border-gray-100 flex items-center justify-end gap-2.5">
                ...
                <button
                  type="submit"
                  className="px-5 py-2.5 text-xs font-bold bg-amber-500 hover:bg-amber-600 text-white rounded-xl shadow-xs transition-all active:scale-95 cursor-pointer hover:shadow-md hover:shadow-amber-100"
                >
                  Simpan Pemenang
                </button>
              </div>
