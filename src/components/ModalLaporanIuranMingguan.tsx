...
import { X, Calendar, Trash2, CreditCard } from 'lucide-react';
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
          ...
          <motion.div
            ...
            className="relative bg-white rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl border border-gray-100 z-10 flex flex-col max-h-[90vh]"
          >
            {/* Header */}
            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-5 space-y-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 text-xs bg-white border border-gray-200 rounded-xl focus:outline-hidden focus:ring-2 focus:ring-red-500 font-medium text-gray-800 cursor-pointer"
                >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-8.5 pr-3 py-2.5 text-xs border border-gray-200 rounded-xl focus:outline-hidden focus:ring-2 focus:ring-red-500 font-mono font-medium text-gray-800"
                    />
                  </div>
                </div>
                <div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 text-xs border border-gray-200 rounded-xl focus:outline-hidden focus:ring-2 focus:ring-red-500 font-mono font-black text-emerald-600"
                  />
                </div>
              </div>
              ...
              <div className="pt-3 border-t border-gray-100 flex items-center justify-end gap-2 shrink-0">
                ...
                <button
                  type="submit"
                  className="px-5 py-2.5 text-xs font-bold text-white bg-emerald-600 hover:bg-emerald-700 rounded-xl shadow-xs transition-all active:scale-95 cursor-pointer hover:shadow-md hover:shadow-emerald-100"
                >
                  Simpan &amp; Lapor
                </button>
              </div>
