                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 text-[10px] bg-red-50 text-red-600 hover:bg-red-100/80 px-2.5 py-1.5 rounded-lg font-bold border border-red-100 transition-all cursor-pointer"
                    >
                      <Plus size={11} />
                      Tambah Baris Item
                    </button>
                    ...
                    {items.map((item, index) => (
                      <div key={item.id} className="flex items-center gap-2">
                        ...
                        <input
                          ...
                          className="flex-1 px-3 py-2 text-xs bg-white border border-gray-200 rounded-lg focus:outline-hidden font-medium text-gray-800"
                        />
                        <input
                          type="number"
                          required
                          ...
                          className="w-24 sm:w-32 px-3 py-2 text-xs bg-white border border-gray-200 rounded-lg focus:outline-hidden text-right font-mono font-bold text-red-600"
                        />
                        <button
                          type="button"
                          onClick={() => handleRemoveItemRow(item.id)}
                          className="p-1.5 text-gray-400 hover:text-red-600 transition-all cursor-pointer rounded-lg hover:bg-gray-100"
                        >
                          <Trash2 size={14} />
                        </button>
                      </div>
